...
function italicLinks(htmlContent) {
    ...
    blueColors.forEach((color, index) => {
        ...
        htmlContent = htmlContent.replace(regex,
            '<a href="link" style="font-family:\'Roboto\', Arial, Helvetica, sans-serif;text-decoration: underline;font-weight: 700;"><em>$1</em></a>'
        );
    });
...
function linksStyles(htmlContent) {
    blueColors.forEach((color, index) => {
        ...
        htmlContent = htmlContent.replace(reg,
            '<a href="link" style="font-family:\'Roboto\', Arial, Helvetica, sans-serif;text-decoration: underline;font-weight: 700;">$2</a>'
        );
    });
             ...
             <tr>
                <td align="center" style="padding-top: 15px; padding-bottom: 15px;">
                  <table cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td align="center" style="border-radius: 10px;font-family:'Roboto', Arial, Helvetica, sans-serif;font-size:18px;font-style:normal;line-height:1.5;text-align:center;font-weight: bold; background-color: #28b628; color: #FFFFFF;" bgcolor="#29b929">
                        <a href="link" target="_blank" style="font-weight: bold;text-decoration:none;color:#ffffff;background-color: #29b929;border-radius: 10px;padding: 12px 20px;display: inline-block;font-family:'Roboto', Arial, Helvetica, sans-serif;font-size:18px;font-style:normal;line-height:1.5;text-align:center;">
                          ${content}
                        </a>
                      </td>
                    </tr>
